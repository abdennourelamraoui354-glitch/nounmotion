        ...
        >
          ...
          <div>
            ...
            <p className="mb-6 text-base leading-relaxed" style={{ color: `${CREAM}70`, fontFamily: 'DM Sans, sans-serif' }}>
              Nestled in the heart of Ghubra, Muscat, our outdoor terrace offers an warm and vibrant Asian dining destination for the whole family.
            </p>
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  icon: '🕐',
                  label: 'Hours',
                  value: `Mon–Thu ${BUSINESS.hours.weekdays} · Fri–Sun ${BUSINESS.hours.weekends}`,
                },
                {
                  icon: '📞',
                  label: 'Phone',
            ...
            <a
              href={`https://maps.app.goo.gl/tnXCiMam6NWU4CQd9`}
              target="_blank"
          ...
          >
            <iframe
              ...
              title="Tawaheen Al Hawa Location"
            />
          </div>
        </motion.div>
      </div>
