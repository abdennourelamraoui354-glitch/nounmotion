...
const FALLBACK_IMG = `${BUSINESS.galleryImages[0]?.src ?? '/tawaheen-alhawa/gallery1.jpg'}`;
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: 'linear-gradient(to top, rgba(10,9,8,0.7) 0%, transparent 60%)' }}
      />
...
export function AtmosphereGallery() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Desktop — pinned horizontal scrub (keep cinematic)
  ...
  return (
    <section id="gallery" ref={containerRef} className="relative overflow-hidden md:h-[100dvh]" style={{ background: '#060504' }}>
      ...
      {/* Mobile — horizontal scroll-snap (no pin, no black void) */}
      <div
