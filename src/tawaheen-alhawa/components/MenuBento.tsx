...
export function MenuBento() {
  ...
  const waHref = `https://wa.me/${BUSINESS.whatsapp.replace(/\D/g, '')}?text=${encodeURIComponent('أود الاستفسار عن القائمة')}`;
              ...
              >
                ...
                <div className="absolute inset-0 overflow-hidden">
                  <motion.img
                    ...
                    decoding="async"
                    onError={(e) => {
                      (e.currentTarget as HTMLImageElement).src = '/tawaheen-alhawa/menu-mezze.jpg';
                    }}
                ...
                {/* Gold top accent */}
                <div className="absolute top-0 left-0 right-0 h-[2px]" style={{ background: `linear-gradient(90deg, transparent, ${GOLD}, transparent)`, opacity: 0 }} />
