...
export function CinematicHero() {
  ...
  const waHref = `https://wa.me/${BUSINESS.whatsapp.replace(/\D/g, '')}?text=${encodeURIComponent('مرحباً، أود حجز طاولة في مطعم الجود')}`;
    ...
    >
      ...
      <AnimatePresence initial={false}>
        ...
        >
          ...
          <div
            className="absolute inset-0"
            style={{ background: 'linear-gradient(135deg, rgba(10,9,8,0.85) 0%, rgba(10,9,8,0.55) 60%, rgba(10,9,8,0.78) 100%)' }}
          />
        </motion.div>
      </AnimatePresence>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 w-full flex flex-col lg:grid lg:grid-cols-2 gap-6 lg:gap-12 items-center pt-16 lg:pt-20">
          ...
          <div className="flex flex-col gap-4 lg:gap-6 w-full">
            ...
            >
              ...
              <span className="text-xs tracking-[0.4em] uppercase" style={{ color: GOLD, fontFamily: 'DM Sans, sans-serif' }}>
            ...
            >
              <MagneticButton>
                <a
                  ...
                  className="relative overflow-hidden px-8 py-4 rounded-full font-semibold text-sm tracking-widest uppercase inline-block"
              ...
              <a
                href="#menu"
                className="px-8 py-4 rounded-full text-sm tracking-widest uppercase border transition-colors duration-300"
            ...
            <div className="flex gap-2 mt-2">
              {BUSINESS.heroSlides.map((_, i) => (
                <button
                  ...
                  style={{ width: i === current ? 24 : 8, height: 8, background: i === current ? GOLD : `${CREAM}40` }}
                />
              ))}
            </div>
          </div>
      ...
      <motion.div
        ...
        style={{ background: 'rgba(10,9,8,0.6)', backdropFilter: 'blur(20px)', border: `1px solid ${GOLD}30` }}
