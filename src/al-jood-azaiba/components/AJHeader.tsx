  ...
  return (
    ...
    >
      <div className="flex flex-col leading-none">
        <span style={{ fontFamily: 'Tajawal, sans-serif', color: GOLD, fontSize: 20, fontWeight: 700 }}>
          {BUSINESS.nameAr}
        </span>
        <span style={{ fontFamily: 'Cormorant Garamond, serif', color: '#FAF7F2', fontSize: 11, letterSpacing: '0.3em', opacity: 0.7, textTransform: 'uppercase' }}>
          {BUSINESS.nameEn}
        </span>
      </div>
      ...
      <a
        ...
        style={{ borderColor: GOLD, color: GOLD, fontFamily: 'DM Sans, sans-serif', background: 'transparent' }}
        onMouseEnter={(e) => {
