        ...
        >
          <div>
            ...
            <p className="mb-6 text-base leading-relaxed" style={{ color: `${CREAM}70`, fontFamily: 'DM Sans, sans-serif' }}>
              Nestled in the heart of Azaiba, Muscat — Al Jood welcomes you to an authentic Lebanese table where every meal feels like a journey to Beirut.
            </p>
          ...
          <div className="rounded-2xl overflow-hidden" style={{ height: 380, border: `1px solid ${GOLD}25` }}>
            <iframe
              ...
              title="Al Jood Lebanese Restaurant Location"
            />
          </div>
        </motion.div>
      </div>
