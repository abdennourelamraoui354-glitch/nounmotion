...
export function ReservationCTA() {
  ...
  const waHref = `https://wa.me/${BUSINESS.whatsapp.replace(/\D/g, '')}?text=${encodeURIComponent('مرحباً، أود حجز طاولة في مطعم الجود اللبناني')}`;

  return (
    <section id="reserve" ref={ref} className="relative py-32 px-6 md:px-12 overflow-hidden" style={{ background: DARK_BG }}>
      <div
        className="absolute inset-0"
        style={{ backgroundImage: `url(${BUSINESS.reservationBg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
      />
      <div
        className="absolute inset-0"
        style={{ background: 'linear-gradient(135deg, rgba(10,9,8,0.9) 0%, rgba(10,9,8,0.68) 100%)' }}
      />
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        >
          ...
          >
            An Evening of Lebanese Flavors
          </h2>
