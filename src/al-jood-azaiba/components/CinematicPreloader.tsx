    ...
    >
      ...
      <div ref={logoRef} className="flex flex-col items-center gap-3 mb-10">
        <svg width="52" height="52" viewBox="0 0 52 52" fill="none">
          ...
          {/* Stylised cedar tree */}
          <path d="M26 10 L34 24 H28 L33 34 H19 L24 24 H18 Z" fill={GOLD} opacity="0.85" />
          <rect x="24.5" y="34" width="3" height="6" rx="1" fill={GOLD} opacity="0.7" />
        </svg>
      ...
      <p ref={tagRef} className="text-[11px] tracking-[0.3em] uppercase mb-8" style={{ color: 'rgba(255,255,255,0.35)' }}>
        Azaiba · Muscat · Lebanese Cuisine
      </p>
