...
import { DARK, ACCENT, BUSINESS } from '../lib/business-data'
    ...
    >
      ...
      <div ref={logoRef} className="flex flex-col items-center gap-3 mb-10">
        <svg width="52" height="52" viewBox="0 0 52 52" fill="none">
          <circle cx="26" cy="26" r="25" stroke={ACCENT} strokeWidth="1.5" />
          <circle cx="26" cy="26" r="18" stroke={ACCENT} strokeWidth="0.5" opacity="0.4" />
          <path d="M26 10 L34 24 L26 42 L18 24 Z" fill={ACCENT} opacity="0.85" />
          <circle cx="26" cy="26" r="3.5" fill={ACCENT} />
        </svg>
        <div className="text-center">
          <p className="text-[10px] tracking-[0.4em] uppercase font-medium" style={{ color: ACCENT }}>
            {BUSINESS.nameAr}
          </p>
      ...
      <div ref={barRef} className="w-48 h-px" style={{ background: 'rgba(255,255,255,0.08)' }}>
        <div ref={barFillRef} className="h-full" style={{ background: ACCENT, transformOrigin: 'left' }} />
      </div>
    </div>
  )
}
