      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div>
            ...
            <h2
              className="mb-6"
              style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 'clamp(2.2rem, 5vw, 4rem)', color: CREAM, fontWeight: 300 }}
            >
              Visit Nabu Cafe
            </h2>
            <p className="mb-6 text-base leading-relaxed" style={{ color: `${CREAM}70`, fontFamily: 'DM Sans, sans-serif' }}>
              Nestled in Souq Al Madina, Muscat — Nabu Cafe welcomes you to an authentic Iraqi table where every bite feels like a journey through Mesopotamia.
            </p>
              ...
              {[
                ...
                <div key={label} className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm" style={{ color: CREAM, fontFamily: 'DM Sans, sans-serif' }}>{value}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="rounded-2xl overflow-hidden" style={{ height: 380, border: `1px solid ${GOLD}25` }}>
            <iframe
              ...
              title="Nabu Cafe Location — Souq Al Madina, Muscat"
            />
          </div>
        </motion.div>
      </div>
