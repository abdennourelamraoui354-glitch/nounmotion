...
export function CinematicHero() {
  ...
  const waHref = `https://wa.me/${BUSINESS.whatsapp.replace(/\D/g, '')}?text=${encodeURIComponent('مرحباً، أود حجز طاولة في مطعم سكون')}`;
    ...
    >
            ...
            >
              <MagneticButton>
                <a
                  ...
                  className="relative overflow-hidden px-8 py-4 rounded-full font-semibold text-sm tracking-widest uppercase block"
              ...
              <MagneticButton>
                <a
                  href="#menu"
                  className="px-8 py-4 rounded-full text-sm tracking-widest uppercase border transition-colors duration-300 hover:border-current block"
      ...
      >
        {[
          ...
          { label: 'Cuisine', value: 'Omani Fusion' },
        ].map(({ label, value }, i) => (
