  ...
  return (
    ...
    >
      <div ref={logoRef} className="flex flex-col items-center gap-4 mb-10">
        {/* Cedar tree motif — Lebanese symbol */}
        <svg width="56" height="56" viewBox="0 0 56 56" fill="none">
          ...
          {/* Cedar trunk */}
          <rect x="26.5" y="36" width="3" height="7" rx="1" fill={GOLD} opacity="0.9" />
          {/* Cedar layers */}
          <polygon points="28,14 36,28 20,28" fill={GOLD} opacity="0.85" />
          <polygon points="28,18 37,30 19,30" fill={GOLD} opacity="0.6" />
          <polygon points="28,22 38,34 18,34" fill={GOLD} opacity="0.4" />
        </svg>
