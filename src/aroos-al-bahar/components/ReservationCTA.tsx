...
export function ReservationCTA() {
  ...
  const waHref = `https://wa.me/${BUSINESS.whatsapp.replace(/\D/g, '')}?text=${encodeURIComponent('مرحباً، أود حجز طاولة في طواحين الهوا')}`;
    ...
    <section id="reserve" ref={ref} className="relative py-32 px-6 md:px-12 overflow-hidden" style={{ background: DARK_BG }}>
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        >
          ...
          >
            {[
              { label: 'Mon – Thu', value: BUSINESS.hours.weekdays },
              { label: 'Fri – Sun', value: BUSINESS.hours.weekends },
            ].map(({ label, value }) => (
